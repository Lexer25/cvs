...
rem тест 2-1.1 имитация паровозика из двух автомобилей на парковку 3.2 ворота подъезжает автомобиль. Система читает и UHF, и ГРЗ
...
C:\xampp\php\php.exe c:\xampp\htdocs\cvs\modules\minion\minion --task=sendKey2 --key=%key014%	--id_gate=2
ping 127.0.0.1 -n 5
C:\xampp\php\php.exe c:\xampp\htdocs\cvs\modules\minion\minion --task=sendKey2 --key=%grz014%	--id_gate=2
ping 127.0.0.1 -n 5
C:\xampp\php\php.exe c:\xampp\htdocs\cvs\modules\minion\minion --task=sendKey2 --key=%keyM567OM799%	--id_gate=2
ping 127.0.0.1 -n 5
C:\xampp\php\php.exe c:\xampp\htdocs\cvs\modules\minion\minion --task=sendKey2 --key=%key22332233%	--id_gate=2
ping 127.0.0.1 -n 5

C:\xampp\php\php.exe c:\xampp\htdocs\cvs\modules\minion\minion --task=sendLoop2 --id_gate=2
ping 127.0.0.1 -n 10
C:\xampp\php\php.exe c:\xampp\htdocs\cvs\modules\minion\minion --task=sendLoop2 --id_gate=2
ping 127.0.0.1 -n 10
C:\xampp\php\php.exe c:\xampp\htdocs\cvs\modules\minion\minion --task=sendLoop2 --id_gate=2
