...
/** 19.07.2025
	...
	*/
	...
	//т.к. гараж может иметь на разых площадках, то и количество свободных мест надо считать для каждой площадки.
		...
		$placeCountUccuped=$garage->getPlaceCountUccuped($this->id_parking);
		$placeCount=$garage->getPlaceCount($this->id_parking);
		Log::instance()->add(Log::NOTICE, '144 -- всего мест :count, занято :occuped.',
			array(
				':count'=>$placeCount,
				':occuped'=>$placeCountUccuped
				));
 		 if($placeCount - $placeCountUccuped >0){
