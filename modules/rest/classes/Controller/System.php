...
/**
 * 20.04.2025 Контроллер для получения информации о текущей версии REST API
 *
 ...
 * @author   Alon Pe'er
 */
class Controller_System extends Controller_Rest {
	...
	public function before()
	{
		...
		parent::before();
		$this->_rest = Model_RestAPI::factory('systems', $this->_user);
